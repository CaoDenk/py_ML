...
def main(args):
    ...
    left_dir=r"E:\Dataset\endo_depth\22_crop_288_496\test\image01"
    right_dir=r"E:\Dataset\endo_depth\22_crop_288_496\test\image02"
    disp_dir=r"E:\Dataset\endo_depth\22_crop_288_496\test\disp_np01"
    right_disp_dir=r"E:\Dataset\endo_depth\22_crop_288_496\test\disp_np02"
    train_dataset=MyDataset.MyDataset(left_dir,right_dir,disp_dir,right_disp_dir)
    train_loader = dataloader.DataLoader(train_dataset, batch_size=1, shuffle=True, num_workers=args.num_workers)
    model=torch.load(r"E:\中期\sttr_light\stereo-transformer\sttr_train 170.pth")
